...
[![Build Status](https://travis-ci.org/rooty/ansible-redis.svg?branch=master)](https://travis-ci.org/rooty/ansible-redis) [![Ansible Galaxy](https://img.shields.io/badge/galaxy-rooty.redis-blue.svg?style=flat)](https://galaxy.ansible.com/rooty/redis)
 - Ansible 2.5+
...
``` bash
$ ansible-galaxy install rooty.ansible_redis
```
